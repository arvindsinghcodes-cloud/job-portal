package com.spring.learning.jobportal.company.service.impl;
...
import com.spring.learning.jobportal.repository.CompanyRepository;
...
import static com.spring.learning.jobportal.constants.ApplicationConstants.ACTIVE_STATUS;
...
//    }
    ...
    public List<CompanyDto> getAllCompanies() {
        List<Company>  companyList= companyRepository.fetchCompaniesWithJobsByStatus(ACTIVE_STATUS);
    ...
    private CompanyDto transformCompanyToDto(Company company) {
        List<JobDto> jobs = company.getJobs().stream().map(ApplicationUtil::transformJobToDto).collect(Collectors.toList());
        return new CompanyDto(
                ...
                company.getFounded(),company.getDescription(),company.getEmployees(),company.getWebsite(),company.getCreatedAt(),jobs
        );
    }
