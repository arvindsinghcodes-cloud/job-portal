package com.spring.learning.jobportal.aspects;

import com.spring.learning.jobportal.dto.RegisterRequestDto;
import com.spring.learning.jobportal.entity.JobPortalUser;
import com.spring.learning.jobportal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.spring.learning.jobportal.auth.AuthController
        .registerUser(..))
        """)
