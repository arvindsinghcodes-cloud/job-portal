package com.spring.learning.jobportal.auth;

import com.spring.learning.jobportal.constants.ApplicationConstants;
import com.spring.learning.jobportal.dto.LoginRequestDto;
import com.spring.learning.jobportal.dto.LoginResponseDto;
import com.spring.learning.jobportal.dto.RegisterRequestDto;
import com.spring.learning.jobportal.dto.UserDto;
import com.spring.learning.jobportal.entity.Job;
import com.spring.learning.jobportal.entity.JobPortalUser;
import com.spring.learning.jobportal.entity.Role;
import com.spring.learning.jobportal.repository.JobPortalUserRepository;
import com.spring.learning.jobportal.repository.RoleRepository;
import com.spring.learning.jobportal.security.util.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto> apiLogin(@RequestBody LoginRequestDto loginRequestDto) {
       try{
           ...
           return  buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR,"An unexpected Error Server Occured");
       }
    }
    ...
    public ResponseEntity<?> registerUser(@RequestBody RegisterRequestDto registerRequestDto) {
        ...
        Role role = roleRepository.findRoleByName(ApplicationConstants.ROLE_JOB_SEEKER).orElseThrow(() -> new IllegalArgumentException("Role Not Found"
